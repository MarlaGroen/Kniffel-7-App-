const CACHE='kniffel7-seven2',ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./icon-7-192.png','./icon-7-512.png','./manifest.webmanifest?v=seven2','./icon.svg?v=seven2'];
